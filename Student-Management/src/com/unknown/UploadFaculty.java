...
@WebServlet("/UploadFaculty")
public class UploadFaculty extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
	Connection con = null;
	final String UPLOAD_DIRECTORY = "D:\\Testing\\MLApproach126\\WebContent\\upload";
	String course;
	String uploadedby;
	String duration;
		...
		if (ServletFileUpload.isMultipartContent(request)) 
		{
			try 
			{
				...
				System.out.println("File Size " + FileSize);
					...
					try {
						/**/
						 PreparedStatement ps =con.prepareStatement("INSERT INTO `filesfaculty` (`id`, `course`, `filename`,`uploadedby`,`duration`) VALUES (NULL,'"+course+"','"+FileName+"','"+uploadedby+"','"+duration+"')");
				...
				response.sendRedirect("adminupload.jsp?upload=done");
				}
