...
{
	out.println("<script>alert('Record Added Successfuly...!!')</script>");
}
%>
<br>
	<div id="header">
			<div id="logo">
				...
				<ul>
					...
					<li class="selected"><a href="aggrigate.jsp"><span>Aggregate</span></a></li>
		...
		<div class="page">
			<div class="left-section">
				<div class="panel">
					...
					<h1><b>User Aggregate Detail</b></h1>

					<table border="20" cellpadding="5">
						<%
