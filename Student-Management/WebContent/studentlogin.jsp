...
<body>
<%
if(request.getParameter("regDone")!=null)
{
...
{
	out.println("<script>alert('Your account not activated yet by Admin')</script>");
}
if(request.getParameter("exp")!=null)
{
	out.println("<script>alert('Your Login Expired')</script>");
}
%>
<br>
	<div id="header">
			<div id="logo">
				...
				<ul>
					...
					<li class="selected"><a href="studentlogin.jsp"><span>Student</span></a></li>
					...
					<div align="center">
						...
						<form action="studentlogin" method="post">
							<table border="5" cellpadding="5" cellspacing="8">
								...
								<tr>
									<td><input type="submit" style="height: 45px; width: 120px;" value="Login" /></td>
									<td align="center"><u>
									<a href="studentregister.jsp"><input type="button" style="height: 45px; width: 120px;" style="color: blue;" value="New Registration" class="button" /></a></u></td>
									<!-- <a href="instrumentsdetails.jsp"><input type='submit' name='Submit' value="Fill Instruments Details" /></a></td> -->
								</tr>
							</table>
						</form>
